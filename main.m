function [landmark_coord,trimmed_coord,cycle_time,gait_cycles] = main(dynamic_trial,static_trial,frame_errors,error_percent)
...
for n = 1:gait_cycle_count - 1
    ...
    segment_error_checks.RLO_RLS = error_check(RLO,RLS,frame_errors,50,static_RLO_RLS,start_frame,end_frame);
    segment_error_checks.RDS_Centroid = error_check(RDS,Centroid,frame_errors,30,static_RDS_Centroid,start_frame,end_frame);
    segment_error_checks.T1_Centroid = error_check(T1,Centroid,frame_errors,30,static_T1_Centroid,start_frame,end_frame);
